...
SpatialHashMap3D::SpatialHashMap3D(std::vector<Particle>& particles,unsigned int size,float cellSize) : AbstractSpatialStruct(particles)
{
    this->size = size;
